...
import { 
  MapPin, Star, Shield, Award, Calendar, Clock, 
  DollarSign, MessageSquare, Share2, Flag, CheckCircle 
} from 'lucide-react';
...
export default function ProviderProfile() {
  ...
  const provider = {
    ...
    coverImage: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1350',
    rating: 4.9,
    reviews: 128,
    completedJobs: 156,
    ...
    about: 'Professional handyman with over 10 years of experience in home repairs, maintenance, and improvements.',
    services: [
      {
        id: 1,
        title: 'General Home Repairs',
        price: '$50/hour',
        description: 'Basic home repairs including fixtures, furniture assembly, and minor repairs.',
